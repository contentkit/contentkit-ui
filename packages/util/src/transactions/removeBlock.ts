...
function removeBlock (editorState: EditorState, blockKey: string) {
  ...
  if (beforeBlock === undefined) {
    ...
    const newState = EditorState.push(editorState, content, (ChangeType.REMOVE_BLOCK as EditorChangeType))
